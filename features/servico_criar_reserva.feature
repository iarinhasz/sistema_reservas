Feature: Serviço de Processamento e Criação de Reservas
  ...
  Scenario: Aprovação de uma solicitação de reserva pendente
    ...
    And um evento de reserva deve ser criado para "Lab1_ID" em "2025-12-10" das "10:00" às "12:00" vinculado ao usuário "professor_silva@email.com"
  ...
  Scenario: Rejeição de uma solicitação de reserva pendente
    Given existe uma solicitação de reserva "REQ456" para o recurso "Auditório_ID" pelo usuário "aluno_joao@email.com" para "2025-11-15" das "14:00" às "16:00", com estado "Pendente"
  ...
  Scenario: Criação de reserva direta por um administrador
    Given o administrador "admin_gestor@email.com" deseja criar uma reserva para o recurso "SalaProjetor_ID"

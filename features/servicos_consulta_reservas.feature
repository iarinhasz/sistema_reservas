Feature: Serviço de Consulta de Dados do Sistema de Reservas
  ...
  Scenario: Obtenção de reservas de um recurso para exibição na agenda semanal
    Given o recurso "Lab1_ID" possui várias reservas aprovadas entre "2025-12-08" e "2025-12-14"
  ...
  Scenario: Obtenção de avaliações de um recurso específico
    Given o recurso "Auditório_ID" possui várias avaliações registradas por usuários (ex: nota 5, comentário "Excelente!"; nota 3, comentário "Iluminação fraca")
  ...
  Scenario: Obtenção do histórico de modificações de equipamentos de um recurso
    Given o recurso "Lab1_ID" teve equipamentos adicionados, removidos e alterados ao longo do tempo, e essas ações foram registradas
